...
export function Phone(props: PhoneProps) {
    return (
        <div className="relative mx-auto h-[580px] w-[280px] rounded-[30px] border-[10px] border-neutral-800 bg-neutral-800 shadow-2xl dark:border-neutral-900 dark:bg-neutral-900">
